...
INTERFACE HDF5_WriteDataSet
  ...
  MODULE PROCEDURE HDF5_WriteDataSet_CHARACTER_rank1
END INTERFACE
...
!
!======================================================================================================================!
SUBROUTINE HDF5_WriteDataSet_CHARACTER_rank1(loc_id,dset_name,data,dimsf,offset)
!----------------------------------------------------------------------------------------------------------------------!
IMPLICIT NONE
!----------------------------------------------------------------------------------------------------------------------!
! FORMAL ARGUMENTS
...
!----------------------------------------------------------------------------------------------------------------------!
CHARACTER(LEN=255)           :: strdata(1:SIZE(data))
!----------------------------------------------------------------------------------------------------------------------!
...
CALL H5TSET_SIZE_F(type_id,str_len,iError)

! Create Dataset
CALL H5DCREATE_F(loc_id,TRIM(dset_name),type_id,fdspace_id,dset_id,iError)
...
! Add CHAR(0): Fortran -> C strings
DO iStr=1,SIZE(data)
  strdata(iStr) = TRIM(data(iStr))!!!//CHAR(0)
END DO

! Write Dataset
CALL H5DWRITE_F(dset_id,type_id,strdata,dims,iError,&
                file_space_id=fdspace_id,mem_space_id=dspace_id,xfer_prp=plist_id)
...
!----------------------------------------------------------------------------------------------------------------------!
END SUBROUTINE HDF5_WriteDataSet_CHARACTER_rank1
!======================================================================================================================!
!
!
!
...
! Add CHAR(0): Fortran -> C strings
strdata = TRIM(data)//CHAR(0)

! Create Datatype
attr_len = LEN_TRIM(strdata,KIND=HID_T)
CALL H5TCOPY_F(H5T_NATIVE_CHARACTER,type_id,iError)
CALL H5TSET_SIZE_F(type_id,attr_len,iError)

! Create Attributes
CALL H5ACREATE_F(obj_id,attr_name,type_id,dspace_id,attr_id,iError)
CALL H5AWRITE_F(attr_id,type_id,strdata,dims,iError)
