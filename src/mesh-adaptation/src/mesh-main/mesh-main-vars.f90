...
TYPE tMeshInfo
  ...
  INTEGER            :: nOutVars
  INTEGER            :: MaxRefLevel
  CHARACTER(LEN=255) :: FileVersion
  CHARACTER(LEN=255) :: CoordNames3D(1:3)
  CHARACTER(LEN=255) :: DataNames3D(1:2)
...
CHARACTER(LEN=255),ALLOCATABLE :: MeshData_BoundaryName(:)
!----------------------------------------------------------------------------------------------------------------------!
...
INTEGER,ALLOCATABLE :: MeshData_MasterSlavesToFaces(:,:)
