...
ParametersMeshAdaptation%MeshDimension               = GetInteger('MeshDimension','3')
...
ParametersMeshAdaptation%ProgramName                 = ProgramName
ParametersMeshAdaptation%FileVersion                 = "2024.09"
...
USE MOD_MeshRefinement,            ONLY: CreateNonConformingConnectivity
USE MOD_MeshAdaptation_vars,       ONLY: ParametersMeshAdaptation
...
INTEGER :: iLevel
!----------------------------------------------------------------------------------------------------------------------!
CHARACTER(LEN=255) :: BaseFileName
!----------------------------------------------------------------------------------------------------------------------!
CHARACTER(LEN=255) :: ErrorMessage
!----------------------------------------------------------------------------------------------------------------------!
INTEGER             :: nNodes
