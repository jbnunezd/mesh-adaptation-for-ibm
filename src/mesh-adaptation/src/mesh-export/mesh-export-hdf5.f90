...
PRIVATE
!----------------------------------------------------------------------------------------------------------------------!
INTERFACE ExportMeshToHDF5_CODA
  MODULE PROCEDURE ExportMesh3DToHDF5_CODA
END INTERFACE
!----------------------------------------------------------------------------------------------------------------------!
PUBLIC :: ExportMeshToHDF5_CODA
!----------------------------------------------------------------------------------------------------------------------!
!
!
!
...
!
!======================================================================================================================!
SUBROUTINE ExportMesh3DToHDF5_CODA(&
  FileName,VarNames,BoundaryMark,BoundaryName,BCFacesToNodes,BCFacesToType,ElementsToNodes,NodesCoordinates,MasterSlavesToNodes)
!----------------------------------------------------------------------------------------------------------------------!
USE HDF5
USE MOD_HDF5_Tools
!----------------------------------------------------------------------------------------------------------------------!
...
INTEGER,INTENT(INOUT)          :: BoundaryMark(:)
...
CHARACTER(LEN=255) :: CODA_MeshImportFormat
CHARACTER(LEN=255) :: CODA_FullFileName
CHARACTER(LEN=255) :: CODA_FileExtension
CHARACTER(LEN=255) :: CODA_Variable0
CHARACTER(LEN=255) :: CODA_Variable1
CHARACTER(LEN=255) :: CODA_Variable2
CHARACTER(LEN=255) :: CODA_CellType
CHARACTER(LEN=255) :: CODA_EmptyString
CHARACTER(LEN=255) :: CODA_NotInitialized
CHARACTER(LEN=255),ALLOCATABLE :: CODA_CADGroupID(:)
!----------------------------------------------------------------------------------------------------------------------!
...
!----------------------------------------------------------------------------------------------------------------------!
END SUBROUTINE ExportMesh3DToHDF5_CODA
!======================================================================================================================!
!
!
!----------------------------------------------------------------------------------------------------------------------!
