...
MeshData_BoundaryMark = ParametersMeshBuiltIn3D%BoundaryMark
...
MeshInfo%FileVersion     = TRIM(ParametersMeshAdaptation%FileVersion)
MeshInfo%ProgramName     = TRIM(ParametersMeshAdaptation%ProgramName)
MeshInfo%ProjectName     = TRIM(ParametersMeshAdaptation%ProjectName)
MeshInfo%BaseFileName    = TRIM(ParametersMeshAdaptation%ProjectName)//"_MESH"
