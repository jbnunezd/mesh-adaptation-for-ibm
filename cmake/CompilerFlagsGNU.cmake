...
#----------------------------------------------------------------------------------------------------------------------#
STRING(TIMESTAMP MAIN_COMPILATION_DATE "%Y-%m-%d")
STRING(TIMESTAMP MAIN_COMPILATION_TIME "%H:%M:%S")
SET(MAIN_STAMP_DATE_ISO_FLAG "-D__DATE_ISO__='\"${MAIN_COMPILATION_DATE}\"'")
SET(MAIN_STAMP_TIME_ISO_FLAG "-D__TIME_ISO__='\"${MAIN_COMPILATION_TIME}\"'")
...
IF (CMAKE_Fortran_COMPILER_ID MATCHES "GNU")
  ...
  SET(MAIN_CXX_FLAGS_OVERALL "${MAIN_CXX_FLAGS_OVERALL} ${MAIN_STAMP_DATE_ISO_FLAG}")
  SET(MAIN_CXX_FLAGS_OVERALL "${MAIN_CXX_FLAGS_OVERALL} ${MAIN_STAMP_TIME_ISO_FLAG}")
  #------------------------------------------#
  # COMMON FORTRAN
  #------------------------------------------#
  ...
  SET(MAIN_Fortran_FLAGS_OVERALL "${MAIN_Fortran_FLAGS_OVERALL} ${MAIN_STAMP_DATE_ISO_FLAG}")
  SET(MAIN_Fortran_FLAGS_OVERALL "${MAIN_Fortran_FLAGS_OVERALL} ${MAIN_STAMP_TIME_ISO_FLAG}")
  #------------------------------------------#
  ...
  SET(MAIN_FLAGS_DEBUGGING "${MAIN_FLAGS_DEBUGGING} -Wno-maybe-uninitialized")
